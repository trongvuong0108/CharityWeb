	...
	<div class="nav__tab">
		<div class="nav">
			...
			<button class="nav-item" id="nav-Account">
				<a href="/doan/admin/taikhoan">Tài khoảng</a>
			</button>
			<button class=" nav-item" id="nav-News">
				<a href="/doan/admin/baidang">Bài Viết</a>
			</button>
			<button class="nav-item" id="nav-Account">
				<a href="/doan/admin/diadiem">Địa điểm</a>
			</button>
			<button class="nav-item active" id="nav-Address">
				<a href="/doan/admin/dothienmau">Đợt Hiến Máu</a>
			</button>
			<button class="nav-item" id="nav-Address">
				<a href="/doan/logout">Đăng Xuất</a>
			</button>
		</div>
			...
			<div id="Address" class="city">
				<div class="account__content">
					<div class="account__table__list" style="flex-basis: 100%">
						...
						<button class="add__address">
							<a href="dothienmau/new">Thêm mới</a>
						</button>
							...
							<c:forEach items="${dothienmaus}" var="dothienmau">
								<div class="content__item">
									...
									<div class="content__des">
										<a href="dothienmau/edit?id=${dothienmau.id}">Edit</a> <a
											href="dothienmau/delete?id=${dothienmau.id}">Delete</a>
									</div>
								</div>
							</c:forEach>
						</div>
